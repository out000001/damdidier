  ...
  return (
    <div className="animate-fade-in">
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <button
          type="button"
          className="w-full py-3 px-4 rounded-xl border-2 border-gray-200 flex items-center justify-center gap-3 text-sm font-semibold text-gray-700 hover:border-gray-300 hover:bg-gray-50 transition-all duration-200"
        >
